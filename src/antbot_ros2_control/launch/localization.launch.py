...
def generate_launch_description():
    ...
    navigation_cfg_path = get_package_share_directory('antbot_ros2_control')
    ...
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        arguments=['-d', PathJoinSubstitution([navigation_cfg_path, 'rviz', LaunchConfiguration('rviz_config')])],
    ...
    launchDescriptionObject.add_action(rviz_cfg_arg)
